...
export class AddressService {
  ...
  toAddressResponse(address: any): AddressResponse {
    return {
      id: address.id,
      city: address.city,
  ...
  async create(
    ...
    const createRequest: CreateAddressRequest = this.validateService.validate(
  ...
  async get(user: User, request: GetAddressRequest): Promise<AddressResponse> {
    const getRequest: GetAddressRequest = this.validateService.validate(
  ...
  async update(
    ...
    const updateRequest: UpdateAddressRequest = this.validateService.validate(
  ...
  async remove(
    ...
    const removeRequest: RemoveAddressRequest = this.validateService.validate(
